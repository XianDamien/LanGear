...
<template>
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
    <RetroCard title="积分">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <div class="text-xs text-slate-500 uppercase">已获得积分</div>
        </div>
      </div>
    </RetroCard>
    ...
    <RetroCard title="今日目标">
      <p class="text-sm text-slate-500 mb-2">熟能生巧</p>
      <ProgressBar :value="stats.dailyDone" :max="stats.dailyGoal" label="句子" />
    </RetroCard>
  </div>
</template>
